...
[`data/stock_prices.csv`](data/stock_prices.csv), so the results do not change when new prices come
in. Prices are adjusted for stock splits, such as Amazon's 20-for-1 split in 2022.

```{r}
#| label: load-csv
prices <- read_csv("data/stock_prices.csv", show_col_types = FALSE)
